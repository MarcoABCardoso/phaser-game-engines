...
Import `@phaser-game-engines/content-tools/tiled` in an authoring build or game.
...
`@phaser-game-engines/content-tools/vite` validates configured files on build
