export type PlatformerLevel = import('@phaser-game-engines/toolkit/core/content.js').LevelSpec & {
    floorSegments?: import('@phaser-game-engines/toolkit/core/content.js').RectSpec[];
    platforms?: import('@phaser-game-engines/toolkit/core/content.js').RectSpec[];
};
