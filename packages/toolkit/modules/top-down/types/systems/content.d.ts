export type TopDownLevel = import('@phaser-game-engines/toolkit/core/content.js').LevelSpec & {
    walls?: import('@phaser-game-engines/toolkit/core/content.js').RectSpec[];
    camera?: {
